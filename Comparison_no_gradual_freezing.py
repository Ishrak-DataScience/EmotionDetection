...
# Unified plotting
f1_scores = {model_name: [] for model_name in model_configs.keys()}
output_dir = "plots"
...
for model_name, config in model_configs.items():
    ...
    scheduler = get_scheduler("linear", optimizer=optimizer, num_warmup_steps=0, num_training_steps=epochs * len(train_texts))
...
plt.legend()
plt.grid()
plt.savefig(os.path.join(output_dir, "model_comparison_f1_score_all_layer_train.png"))
plt.show()
